...
export default function RegisterPage() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(submit)}>
        <Input label="Seu nome" type="name" register={register("name")} error={errors.name}/>
        <Input label="Seu email" type="email" register={register("email")} error={errors.email}/>
        <Input label="Seu senha" type="password" register={register("password")} error={errors.password}/>
        <Input label="Seu avatar" type="img" register={register("img")} error={errors.img}/>
